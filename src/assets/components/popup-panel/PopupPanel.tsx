...
export default function PopupPanel(props: PanelProps) {
  return <div id="popup-modal" style={{position:'fixed',top:'0%', left:'0%', width:'100%', height:'100%',zIndex:11, backgroundColor:'#444444be'}}>
    <motion.div id="popup-panel" className='popup-panel'
