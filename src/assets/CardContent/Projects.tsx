...
export default function Projects() {
    ...
    function createProjectCard(content: projectContent, idx: number) {
        ...
        >
            <div className='project-top'>
                <div className='image-container' style={{ backgroundImage: `url(${content.img})` }}>
    ...
    /**
     * 
     * @param prog parallax progress
     * @param low lower bound
     * @param high upper bound. defaults to low + 1
     * @returns low <= prog < high
     */
    function inRange(prog: number, low: number, high?: number) {
        return low <= prog && prog < (high || low + 1 + 0.001)
    }
